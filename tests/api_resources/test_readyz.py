...
class TestReadyz:
    ...
    def test_method_check(self, client: Fastvm) -> None:
        readyz = client.readyz.check()
        assert readyz is None

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_check(self, client: Fastvm) -> None:
        response = client.readyz.with_raw_response.check()

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        readyz = response.parse()
        assert readyz is None

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_check(self, client: Fastvm) -> None:
        with client.readyz.with_streaming_response.check() as response:
...
class TestAsyncReadyz:
    ...
    async def test_method_check(self, async_client: AsyncFastvm) -> None:
        readyz = await async_client.readyz.check()
        assert readyz is None

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_check(self, async_client: AsyncFastvm) -> None:
        response = await async_client.readyz.with_raw_response.check()

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        readyz = await response.parse()
        assert readyz is None

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_check(self, async_client: AsyncFastvm) -> None:
        async with async_client.readyz.with_streaming_response.check() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
