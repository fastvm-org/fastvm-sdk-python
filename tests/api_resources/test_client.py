...
class TestClient:
    ...
    @parametrize
    def test_method_health(self, client: Fastvm) -> None:
        client_ = client.health()
        assert_matches_type(HealthResponse, client_, path=["response"])

    @parametrize
    def test_raw_response_health(self, client: Fastvm) -> None:
    ...
    @parametrize
    def test_streaming_response_health(self, client: Fastvm) -> None:
...
class TestAsyncClient:
    ...
    @parametrize
    async def test_method_health(self, async_client: AsyncFastvm) -> None:
        client = await async_client.health()
        assert_matches_type(HealthResponse, client, path=["response"])

    @parametrize
    async def test_raw_response_health(self, async_client: AsyncFastvm) -> None:
    ...
    @parametrize
    async def test_streaming_response_health(self, async_client: AsyncFastvm) -> None:
