...
class TestLivez:
    ...
    def test_method_check(self, client: Fastvm) -> None:
        livez = client.livez.check()
        assert livez is None

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_check(self, client: Fastvm) -> None:
        response = client.livez.with_raw_response.check()

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        livez = response.parse()
        assert livez is None

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_check(self, client: Fastvm) -> None:
        with client.livez.with_streaming_response.check() as response:
...
class TestAsyncLivez:
    ...
    async def test_method_check(self, async_client: AsyncFastvm) -> None:
        livez = await async_client.livez.check()
        assert livez is None

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_check(self, async_client: AsyncFastvm) -> None:
        response = await async_client.livez.with_raw_response.check()

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        livez = await response.parse()
        assert livez is None

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_check(self, async_client: AsyncFastvm) -> None:
        async with async_client.livez.with_streaming_response.check() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
