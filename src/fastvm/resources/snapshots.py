...
from ..types import snapshot_create_params, snapshot_update_params
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            ...
            body=maybe_transform({"name": name}, snapshot_update_params.SnapshotUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=SnapshotObject,
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            path_template("/v1/snapshots/{id}", id=id),
            body=await async_maybe_transform({"name": name}, snapshot_update_params.SnapshotUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=SnapshotObject,
