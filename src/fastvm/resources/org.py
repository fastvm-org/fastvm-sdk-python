...
from ..types.org_retrieve_quotas_response import OrgRetrieveQuotasResponse
    ...
    def retrieve_quotas(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=OrgRetrieveQuotasResponse,
        )
...
class OrgResourceWithRawResponse:
    def __init__(self, org: OrgResource) -> None:
        ...
        self.retrieve_quotas = to_raw_response_wrapper(
            org.retrieve_quotas,
        )
...
class AsyncOrgResourceWithRawResponse:
    def __init__(self, org: AsyncOrgResource) -> None:
        ...
        self.retrieve_quotas = async_to_raw_response_wrapper(
            org.retrieve_quotas,
        )
...
class OrgResourceWithStreamingResponse:
    def __init__(self, org: OrgResource) -> None:
        ...
        self.retrieve_quotas = to_streamed_response_wrapper(
            org.retrieve_quotas,
        )
...
class AsyncOrgResourceWithStreamingResponse:
    def __init__(self, org: AsyncOrgResource) -> None:
        ...
        self.retrieve_quotas = async_to_streamed_response_wrapper(
            org.retrieve_quotas,
        )
